		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "List",
									"targetURL": "#uiListproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiListproject1-display": {
								"semanticObject": "uiListproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.List.project1",
									"url": sap.ui.require.toUrl("ui/List/project1")
								}
							}
						}
					}
