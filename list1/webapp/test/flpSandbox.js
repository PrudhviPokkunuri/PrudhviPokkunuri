		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training",
									"targetURL": "#uifirstapplist1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uifirstapplist1-display": {
								"semanticObject": "uifirstapplist1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.firstapp.list1",
									"url": sap.ui.require.toUrl("ui/firstapp/list1")
								}
							}
						}
					}
