		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training",
									"targetURL": "#uiprojectappproject1-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiprojectappproject1-display": {
								"semanticObject": "uiprojectappproject1",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.projectapp.project1",
									"url": sap.ui.require.toUrl("ui/projectapp/project1")
								}
							}
						}
					}
