		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Training",
									"targetURL": "#uisecondprojectproject2-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uisecondprojectproject2-display": {
								"semanticObject": "uisecondprojectproject2",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.secondproject.project2",
									"url": sap.ui.require.toUrl("ui/secondproject/project2")
								}
							}
						}
					}
